...
export default async function PortfolioPage() {
    ...
    return (
      <div className="mx-auto max-w-6xl p-6 space-y-3 text-slate-900">
        ...
        <div className="text-sm text-slate-600">
          No default portfolio found. Create one in Portfolios.
        </div>
  ...
  return (
    <div className="mx-auto max-w-6xl p-6 space-y-6 text-slate-900">
      ...
      <PositionsClient openPositions={open as any} closedPositions={closed as any} closedSummary={closedSummary} />
    </div>
  );
}