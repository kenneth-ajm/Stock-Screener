  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto overscroll-contain">
      ...
      <div className="pointer-events-none relative flex min-h-full items-start justify-center p-3 sm:items-center sm:p-4">
        <div className="pointer-events-auto relative flex max-h-[calc(100dvh-1.5rem)] min-h-0 w-full max-w-lg flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl sm:max-h-[calc(100dvh-2rem)]">
